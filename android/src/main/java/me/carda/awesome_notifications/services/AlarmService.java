...
public class AlarmService extends Service {
    ...
    //-------3. PABLO-----------
    //Servicio que se ejecuta cuando llega la notificacion del pending intent
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
      ...
      /*  IntentFilter filter = new IntentFilter();
        ...
        startForeground(1, new NotificationHelper(this, 1).deliverNotification());
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.Q) {
            ...
            alarmActivityIntent.putExtra("alarmIdKey", 1);
